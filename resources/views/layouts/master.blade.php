...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('storage/css/style.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('storage/css/demo.css') }}">
</head>
<body>

        @yield('content')
    <div class="bg-dark mt-5 p-5">
        <h4 class="text-center">Copyright &copy; 2021 Reserved || Store Check</h4>
    </div>
